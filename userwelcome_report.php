...
$query=mysql_query("SELECT * FROM user_status WHERE date <='$to' and date>='$from' and emp_code IN (SELECT emp_code from employeedetails where email='$_SESSION[username]')");
